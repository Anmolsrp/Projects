...
class MarvellousLogin extends Template implements ActionListener, Runnable
{
	...
	MarvellousLogin()
	{
		...
		label3.setBoiunds(50,250, l3size.width, l3size.height);
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if( ae.getSource() == minimize )
		{
			...
			else
			{
				...
				if(attemp == 0)
				{
					JOptionPane.showMessageDialog(this, "Number of attempts finished","Marvelous Packer Unpacker", JOptionPane.ERROR_MESSAGE);
					this.dispose();
					System.exit(0);
				}
	...
	public void run()
	{
		for(;;)
		{
			...
			{
				if( Toolkit.detDefaultToolkit().getLockingKeyState (KeyEvent.VK_CAPS_LOCK))
				{
